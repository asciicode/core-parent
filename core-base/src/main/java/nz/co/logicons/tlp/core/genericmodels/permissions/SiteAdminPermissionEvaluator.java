 ...
 * SITEADMIN role can create, update and delete.
 * All other may read.
 * @author bhambr
 *
 */
public class SiteAdminPermissionEvaluator extends PermissionEvaluator
{

  public SiteAdminPermissionEvaluator(Schema<?> schema)
  {
    super(null, schema);
  }
